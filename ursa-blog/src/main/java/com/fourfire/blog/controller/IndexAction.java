...
public class IndexAction{
	Logger logger = LogManager.getLogger(IndexAction.class);
	...
	public String indexView(HttpServletRequest request,HttpServletResponse response){
		logger.info("Come here index");
		System.out.println("Come here index");
		
		//导航
		List<Map<String, Object>> typeList=tdao.getAllTypeInfo();
		request.setAttribute("typeList", typeList);
		System.out.println("typeList is " + typeList);
